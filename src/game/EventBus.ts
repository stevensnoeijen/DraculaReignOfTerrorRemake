...
export class EventBus<DetailOptions> {
  ...
  public on<Detail extends DetailOptions>(
    type: string,
  ...
  public once<Detail extends DetailOptions>(
    type: string,
    listener: CustomEventListener<Detail>
  ): void {
    this.eventTarget.addEventListener(type, listener as EventListener, {
  ...
  public off<Detail extends DetailOptions>(
    type: string,
    listener: CustomEventListener<Detail>
  ): void {
  ...
  public emit<Detail extends DetailOptions>(
    type: string,
    detail?: Detail
  ): boolean {
