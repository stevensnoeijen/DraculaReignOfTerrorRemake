...
export const isInRange = (targetEntity: Entity, maxRange: number): Predicate<Entity> => {
    ...
    return (entity) => {
        ...
        return Vector2.distance(targetPosition, transformComponent.position) <= maxRange;
    };
};
