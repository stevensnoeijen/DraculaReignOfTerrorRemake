...
describe('Vector2', () => {
    ...
    describe('scale', () => {
        test('simple', () => {
            expect(Vector2.scale(new Vector2(2, 2), new Vector2(2, 2))).toEqual({ x: 4, y: 4, });
        });
    });
    describe('min', () => {
        test('simple', () => {
            expect(Vector2.min(new Vector2(1, 2), new Vector2(2, 1))).toEqual({ x: 1, y: 1, });
        });
    });
    describe('max', () => {
        test('simple', () => {
            expect(Vector2.max(new Vector2(1, 2), new Vector2(2, 1))).toEqual({ x: 2, y: 2, });
        });
    });
    describe('subtracts', () => {
        test('simple', () => {
            expect(Vector2.subtracts(new Vector2(1, 1), new Vector2(1, 1))).toEqual({ x: 0, y: 0, });
        });
    });
    describe('multiplies', () => {
        test('simple', () => {
