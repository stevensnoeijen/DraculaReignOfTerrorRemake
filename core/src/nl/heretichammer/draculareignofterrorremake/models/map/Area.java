...
import nl.heretichammer.draculareignofterrorremake.models.items.containers.ItemContainerFactory;
import nl.heretichammer.draculareignofterrorremake.models.producers.itemproducer.ItemProducerManager;
import nl.heretichammer.draculareignofterrorremake.models.producers.troopproducer.TroopProducerManager;
...
public class Area implements Teamable, ItemSupplier {
	...
	public void week() {
		itemProducerManager.week();
		troopProducerManager.week();
	}
