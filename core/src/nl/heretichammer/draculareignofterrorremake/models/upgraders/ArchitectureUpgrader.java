...
public class ArchitectureUpgrader extends Upgrader {
	...
	@Upgrade(level=1, cost=@ResourceCost(time=0, gold=0), image="council.pack:upgrade-architecture-1")
	protected void upgrade1(){
		
	}
	
	@Upgrade(level=2, cost=@ResourceCost(gold=150, time=7), image="council.pack:upgrade-architecture-2")
	...
	@Upgrade(level=3, cost=@ResourceCost(gold=200, time=9), image="council.pack:upgrade-architecture-3")
	...
	@Upgrade(level=4, cost=@ResourceCost(gold=250, time=10), image="council.pack:upgrade-architecture-4")
