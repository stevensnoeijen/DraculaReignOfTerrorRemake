...
public class SaveWindow implements ScreenWindow {
	...
	public void load(AssetManager assetManager) {
		...
		assetManager.load("layout/SaveWindow.xml", Actor.class, new ActorLoader.ActorLoaderParameter(ui));
	}

	@Override
	public void loaded(AssetManager assetManager) {
		AssetUtils.bind(this, assetManager);
		window = (Window) assetManager.get("layout/SaveWindow.xml", Actor.class);
	}
